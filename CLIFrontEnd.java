...
public class CLIFrontEnd {
    ...
    public void start() {
        ...
        System.out.print("Do you want to (1) Log in or (2) Sign up or (3) close app? Enter choice: ");
    ...
    private void inactivityTimer() {
        ...
        inactivity = new Timer(true);
        inactivity.schedule(new TimerTask() {
            @Override
            public void run() {
                System.out.println("\n[System] You have been logged out due to inactivity.");
